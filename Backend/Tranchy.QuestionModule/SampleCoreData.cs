...
{
    internal static class SampleCoreData
    {
        public static async Task<bool> Seed()
        {
            ...
            await DB.InsertAsync(questionCategories, cancellation: default);
            ...
            await DB.InsertAsync(questionPriorities, cancellation: default);
